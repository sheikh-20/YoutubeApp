 ...
 * Use the [LoginWithPasswordFragment.newInstance] factory method to
...
class LoginWithPasswordFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment LoginWithPasswordFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            LoginWithPasswordFragment().apply {
